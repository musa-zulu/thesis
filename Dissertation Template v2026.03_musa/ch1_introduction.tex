...
% ------------------------------------------------------------------------------
\section{Referencing}
References can be cited so that the author names(s) are a part of the sentence, e.g., \textcite{Mhlongo2023}, \textcite{Ofusori2024}, or \textcite{Achuthan2026}.

Alternatively, references can be cited so that the author names appear in the brackets (for when the name of the author is not relevant to the sentence), e.g., \parencite{Mhlongo2023},  \parencite{Ofusori2024}. You can also use the \verb|\autocite| command for end of sentence citations \autocite{Ofusori2024,Mhlongo2023,Achuthan2026}.
