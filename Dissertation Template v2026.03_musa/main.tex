...
The rapid adoption of generative artificial intelligence (AI) coding assistants is changing how software engineering teams develop, test, document, and deliver software. While existing research has shown that AI coding assistants can improve developer productivity and task completion, these improvements do not automatically translate into organizational return on investment (ROI). The value gained from AI adoption is also influenced by how organizations lead, support, and integrate these technologies into everyday software development practices. This study investigates how organizational culture and strategic leadership influence the realization of ROI from AI coding assistants in software engineering teams. The study is guided by Technology Value Realization Theory and the Socio-Technical Systems perspective, which provide a basis for understanding how technological benefits depend on both organizational and human factors.

A quantitative research approach is used to examine the relationships between organizational culture, strategic leadership, AI coding assistant assimilation quality, and ROI. The study focuses on software engineering teams in medium to large organizations in South Africa that have adopted AI coding assistants. Data will be collected through a structured questionnaire using Likert-scale measures. The study examines AI coding assistant ROI across three levels, namely effects on productivity at the task level, effects on integration and coordination at the workflow level, and effects on the firm's business finance and innovation at the firm level. AI coding assistant assimilation quality is examined as a mediating variable, while organizational readiness, team maturity and experience, and adoption duration are included as control variables.

The study seeks to address a gap in existing research by moving beyond the measurement of individual developer productivity and examining how organizational conditions contribute to the realization of value from AI coding assistants. Statistical analysis, including Structural Equation Modelling, will be used to assess the reliability and validity of the measurement model and to test the proposed relationships between the study variables. The study is expected to provide evidence on whether organizational culture and strategic leadership influence AI-related ROI directly and through effective assimilation of AI coding assistants into software engineering workflows.

The study contributes to research on AI value realization by connecting technological performance with organizational culture, leadership, and effective technology assimilation. The findings are expected to provide practical guidance for software engineering leaders and organizations seeking to introduce AI coding assistants in a way that supports measurable productivity, workflow, financial, and innovation outcomes.

\textbf{KEYWORDS:} Artificial intelligence, AI coding assistants, organizational culture, strategic leadership, technology value realization, assimilation quality, return on investment, software engineering.
...
% ------------------------------------------------------------------------------
\chapter*{Significance/rationale}
\addcontentsline{toc}{chapter}{Significance/rationale}

Generative AI has the potential to revolutionize the field of software engineering by increasing productivity as well as the quality of the output in tasks related to knowledge work \autocite{Brynjolfsson2025, Peng2023}. Coding assistants using AI improve the speed as well as the probability of completing tasks by developers. However, the relationship between the productivity of using AI coding assistants and the ROI of software engineering teams is not well understood.
...
%  Scope/Delimitation
% ------------------------------------------------------------------------------
\chapter*{Scope/Delimitation}
\addcontentsline{toc}{chapter}{Scope/Delimitation}
...
\addcontentsline{toc}{chapter}{Delimitation}
...
% ------------------------------------------------------------------------------
\chapter*{Theoretical / Conceptual framework}
\addcontentsline{toc}{chapter}{Theoretical / Conceptual framework}
